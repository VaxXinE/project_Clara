...
VALIDATOR_RULES = (
    ...
    ValidatorRule(
        ...
        "safety",
        ValidatorAuthorityOwner.BACKEND_SAFETY,
        "CRITICAL",
        RetryInstructionType.TECHNICAL_CORRECTION,
    ...
    ValidatorRule(
        ...
        "CRITICAL",
        RetryInstructionType.TECHNICAL_CORRECTION,
        "personalized_transaction_instruction_detected",
    ),
    ValidatorRule(
        ...
        "CRITICAL",
        RetryInstructionType.TECHNICAL_CORRECTION,
        "all_funds_instruction_detected",
    ),
    ValidatorRule(
        ...
        "CRITICAL",
        RetryInstructionType.TECHNICAL_CORRECTION,
        "verification_access_not_available",
    ),
    ValidatorRule(
        ...
        "CRITICAL",
        RetryInstructionType.TECHNICAL_CORRECTION,
        "account_or_fund_access_not_available",
    ),
    ValidatorRule(
        ...
        "CRITICAL",
        RetryInstructionType.TECHNICAL_CORRECTION,
        "refund_authority_not_available",
    ),
)
...
SAFETY_COVERAGE_MATRIX = (
    SafetyCoverageEntry(
        ...
        True,
        True,
        "Deterministic clear-claim coverage; nuanced or implied claims remain.",
    ),
    SafetyCoverageEntry(
        "no_risk_free_claim",
        ("risk_free_claim",),
    ...
    SafetyCoverageEntry(
        ...
        True,
        True,
        "Clear personalized instructions only; complex advice remains.",
    ),
    SafetyCoverageEntry(
    ...
    SafetyCoverageEntry(
        ...
        True,
        True,
        "Capability-aware phrase detection; indirect claims may remain.",
    ),
    SafetyCoverageEntry(
