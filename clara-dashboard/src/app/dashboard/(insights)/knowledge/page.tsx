          ...
          <section className="space-y-4">
            ...
            {!isLoading && items.length > 0 && (
              <div className="rounded-[22px] border border-slate-200 bg-white px-4 py-3 text-sm text-slate-600">
                Pilih satu entry di daftar untuk membaca isi lengkapnya di panel detail. Ini lebih cepat daripada scroll semua knowledge dari atas ke bawah.
              </div>
            )}
            ...
            {!isLoading &&
              items.length > 0 && (
                <section className="grid gap-4 xl:grid-cols-[0.9fr_1.1fr]">
                  <div className="space-y-3 xl:max-h-[78vh] xl:overflow-y-auto xl:pr-1">
                    {items.map((item) => {
                  ...
                  {selectedKnowledge ? (
                    <article className="clara-card rounded-[30px] p-5 xl:sticky xl:top-28">
                      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                        <div>
                          ...
                          <p className="mt-2 text-sm leading-6 text-slate-600">
                            Detail lengkap knowledge yang sedang dipilih. Pakai panel ini saat benar-benar ingin membaca isi penuh atau melakukan edit.
                          </p>
                        </div>
                        ...
                        {canManageKnowledge ? (
                          <div className="flex gap-2">
                            ...
                            <button
                              type="button"
                              onClick={() => void handleDelete(selectedKnowledge.id)}
                      ...
                      <div className="mt-5 rounded-[24px] border border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-5">
                        ...
                        <div className="mt-4 max-h-[52vh] overflow-y-auto whitespace-pre-wrap text-sm leading-7 text-slate-700">
